...
export const glossaryTerms: GlossaryCategory[] = [
    ...
    },
    {
        ...
        terms: [
            ...
            { term: 'League Player', def: 'A registered patron (User) who has officially joined the League. Players earn points, track progress, and unlock digital trophies (Badges). (Formerly referred to as Member).' },
    ...
    },
    {
        ...
        terms: [
            ...
            { term: 'The Brew House', def: 'The Partner Portal. The dashboard where Venue Owners manage their profile, listings, events, and "Flash Deal" activations.' },
