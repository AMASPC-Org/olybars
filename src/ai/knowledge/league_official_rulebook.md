...
* **Cool-down:** The system prevents rapid-fire point accumulation to prioritize neighborhood respect and personal safety.
* *Why?* To encourage enjoying the venue, not just sprinting for points. We build for vibes, not over-consumption.

## 3. Disqualification
* Any use of GPS spoofers, emulators, or account sharing will result in an immediate Season Ban.
* Harassment of venue staff or other players results in a permanent platform ban.
* Excessive "Buzz Spam" (false reporting) will result in a point reset.
