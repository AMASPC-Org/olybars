  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-6 space-y-6">
      ...
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold text-[#39ff14] tracking-tight font-['Bangers'] tracking-wide uppercase">
              ...
              className={`px-3 py-1.5 text-xs font-['Bangers'] tracking-wider border-2 transition uppercase
                ${
                  activeSection === tab.id
                    ...
                    : "bg-slate-800 text-slate-200 border-slate-600 hover:border-[#39ff14]"
                }`}
            >
              {tab.label}
            </button>
      ...
      >
        ...
        <p className="text-sm text-slate-200 font-['Roboto_Condensed'] font-bold">
          ...
          <span className="text-[#39ff14]">your bar talks about it</span>. This
        ...
        <div className="grid gap-3 sm:grid-cols-3 mt-2 text-xs text-slate-300 font-['Roboto_Condensed']">
          <div className="border-2 border-slate-600 bg-slate-900 p-3">
            <p className="font-black text-[#39ff14] mb-1 uppercase">
          ...
          {(Object.keys(POST_TYPE_LABELS) as PostTypeKey[]).map((key) => (
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="text-[10px] px-2 py-0.5 bg-[#39ff14] text-black border border-black uppercase font-black">
                  Draft
                </span>
              </div>
              <textarea
                ...
                className="w-full min-h-[120px] text-xs bg-black border border-slate-700 px-2 py-1.5 text-white resize-vertical focus:outline-none focus:border-[#39ff14] font-mono"
              />
              <div className="flex flex-wrap items-center gap-2 justify-between">
                <div className="flex gap-1">
                  <button
                    type="button"
                    className="text-[10px] px-2 py-1 bg-slate-800 border border-slate-600 hover:border-[#39ff14] transition font-bold uppercase text-slate-300"
                  >
                    Generate
                  </button>
                  <button
      ...
      >
        ...
        <div className="border-t-2 border-black border-dashed pt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <button
            type="button"
            className="inline-flex items-center justify-center px-3 py-1.5 bg-slate-900 border-2 border-slate-600 text-xs font-black text-white hover:border-[#39ff14] transition uppercase tracking-wide"
          >
            Request more materials
          </button>
          <p className="text-[11px] text-slate-400 font-['Roboto_Condensed']">
            For now, text Artie <span className="font-mono text-[#39ff14]">'marketing help'</span>
          </p>
        </div>
      </section>
