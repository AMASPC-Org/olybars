...
const OwnerDashboard: React.FC<OwnerDashboardProps> = ({ isOpen, onClose, venues, updateVenue, openInfo, onViewPage }) => {
    ...
    return (
        <div className="fixed inset-0 bg-slate-900 z-[80] overflow-y-auto flex flex-col animate-in slide-in-from-bottom duration-300">
            {/* Command Header */}
            <div className="sticky top-0 z-10 bg-slate-900 border-b-4 border-[#39ff14] p-4 shadow-lg flex justify-between items-center">
